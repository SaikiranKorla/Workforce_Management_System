...
from appointment.tests.mixins.base_mixin import (
    AppointmentMixin, AppointmentRequestMixin, ConfigMixin, ServiceMixin, WorkerMixin, UserMixin)
from appointment.views import get_appointments_and_slots


class SlotAvailabilityTest(TestCase, UserMixin, ServiceMixin, WorkerMixin, AppointmentRequestMixin,
