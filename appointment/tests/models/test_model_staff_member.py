...
from appointment.models import DayOff, Service, Worker, WorkingHours
from appointment.tests.mixins.base_mixin import ConfigMixin, ServiceMixin, WorkerMixin, UserMixin


class WorkerModelTestCase(TestCase, UserMixin, ServiceMixin, WorkerMixin, ConfigMixin):
    def setUp(self):
    ...
    def test_staff_member_without_service(self):
        ...
        new_staff_member = Worker.objects.create(user=self.user)
    ...
    def test_str_representation(self):
        """Test the string representation of a Worker."""
