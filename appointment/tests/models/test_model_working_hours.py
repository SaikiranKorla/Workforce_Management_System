...
from appointment.tests.mixins.base_mixin import ServiceMixin, WorkerMixin, UserMixin


class WorkingHoursModelTestCase(TestCase, UserMixin, ServiceMixin, WorkerMixin):
    def setUp(self):
