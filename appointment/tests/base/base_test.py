...
from appointment.tests.mixins.base_mixin import (
    AppointmentMixin, AppointmentRequestMixin, AppointmentRescheduleHistoryMixin, ServiceMixin, WorkerMixin,
    UserMixin
)


class BaseTest(TestCase, UserMixin, WorkerMixin, ServiceMixin, AppointmentRequestMixin, AppointmentMixin,
